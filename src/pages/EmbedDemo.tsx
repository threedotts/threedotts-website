...
const EmbedDemo = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?organizationId=1e926240-b303-444b-9f8c-57abd9fa657b&v=40';
...
<script src="https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?organizationId=your-organization-id&v=40"></script>

<!-- OR configure via JavaScript -->
<script src="https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?v=40"></script>
<script>
...
<script src="https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?organizationId=your-org-id&v=40"></script>
