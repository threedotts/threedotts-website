...
const EmbedDemo = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?v=22';
    script.onload = () => {
...
<script src="https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?v=22"></script>
<script>
