...
const EmbedDemo = () => {
  ...
  useEffect(() => {
    ...
    script.src = 'https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?v=23';
    script.onload = () => {
...
<script src="https://dkqzzypemdewomxrjftv.supabase.co/functions/v1/widget-script?v=23"></script>
<script>
