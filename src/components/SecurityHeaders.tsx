...
export const SecurityHeaders = () => {
  useEffect(() => {
    ...
    cspMeta.content = `
      default-src 'self'; 
      script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://cdn.jsdelivr.net https://unpkg.com https://cdn.gpteng.co https://api.us.elevenlabs.io https://dkqzzypemdewomxrjftv.supabase.co https://*.supabase.co;
      ...
      worker-src 'self' blob: https://cdn.jsdelivr.net https://unpkg.com https://api.us.elevenlabs.io https://dkqzzypemdewomxrjftv.supabase.co;
