...
export const SecurityHeaders = () => {
  useEffect(() => {
    ...
    cspMeta.content = `
      ...
      connect-src 'self' https://dkqzzypemdewomxrjftv.supabase.co https://*.supabase.co wss://*.supabase.co https://elevenlabs.io https://*.elevenlabs.io wss://*.elevenlabs.io https://api.us.elevenlabs.io wss://api.us.elevenlabs.io; 
